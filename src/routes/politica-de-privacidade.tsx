...
const descricao =
  "Saiba como a Trinity Digital coleta, utiliza e protege os dados pessoais enviados pelo site.";
    ...
    <Section className="pt-32 md:pt-40">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-6 leading-relaxed text-muted-foreground">
          <p>
            Esta política descreve como a {site.nome} trata os dados pessoais coletados por meio
          ...
          <p>
            Coletamos nome, empresa, WhatsApp, e-mail, serviço de interesse, orçamento estimado e
            mensagem enviados voluntariamente nos formulários, além de dados de navegação anônimos
            por ferramentas de análise.
          </p>
          <h2 className="text-xl font-semibold text-foreground">Finalidade</h2>
          <p>
            Os dados são utilizados exclusivamente para responder solicitações, elaborar propostas
            comerciais e melhorar a experiência no site. Não vendemos nem compartilhamos dados com
            terceiros para fins publicitários.
          </p>
          <h2 className="text-xl font-semibold text-foreground">Cookies e análise</h2>
          <p>
            Podemos utilizar cookies e ferramentas como Google Analytics, Google Tag Manager e Meta
            Pixel para medir desempenho e otimizar campanhas. Você pode desativar cookies no seu
            navegador.
          </p>
