...
const descricao =
  "Condições de uso do site da Trinity Digital, direitos de propriedade intelectual e responsabilidades.";
    ...
    <Section className="pt-32 md:pt-40">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-6 leading-relaxed text-muted-foreground">
          ...
          <p>
            Todo o conteúdo publicado — textos, imagens, marcas e códigos — pertence à {site.nome} e
            não pode ser reproduzido sem autorização prévia por escrito.
          </p>
          <h2 className="text-xl font-semibold text-foreground">Serviços e propostas</h2>
          <p>
            As informações deste site têm caráter informativo. Escopo, prazos e valores são
            definidos individualmente em proposta comercial formal.
          </p>
          <h2 className="text-xl font-semibold text-foreground">Limitação de responsabilidade</h2>
          <p>
            Empenhamo-nos em manter as informações corretas e atualizadas, mas não nos
            responsabilizamos por decisões tomadas exclusivamente com base no conteúdo publicado.
          </p>
